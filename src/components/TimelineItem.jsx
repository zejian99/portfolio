...
function TimelineItem({ year, title, duration, details, position, company }) {
    return (
        <ol className="flex flex-col md:flex-row relative border-l border-stone-200 dark:border-stone-700">
            <li className="mb-10 ml-4">
                ...
                <div className="mt-2 text-base font-semibold text-stone-700 dark:text-stone-300">
                    {company}
                </div>
                {position && (
                    <div className="mt-4 mb-2 text-sm font-normal text-stone-500 dark:text-stone-400">
                        {position}
                    </div>
                )}
